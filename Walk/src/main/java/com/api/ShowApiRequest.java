...
public class ShowApiRequest extends NormalRequest {
    ...
    private String addSign() throws IOException {
        if (textMap.get(com.show.api.Constants.SHOWAPI_APPID) == null) return errorMsg(com.show.api.Constants.SHOWAPI_APPID + "不得为空!");
        textMap.put(com.show.api.Constants.SHOWAPI_SIGN, ShowApiUtils.signRequest(textMap, appSecret));
        return null;
    }
    ...
    private String errorMsg(String msg) {
        String str = "{" + com.show.api.Constants.SHOWAPI_RES_CODE + ":-1," + com.show.api.Constants.SHOWAPI_RES_ERROR + ":\"" + msg + "\"," + Constants.SHOWAPI_RES_BODY + ":{}}";
        return str;
    }
